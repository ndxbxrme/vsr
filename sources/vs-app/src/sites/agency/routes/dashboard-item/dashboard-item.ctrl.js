...
(function() {
  'use strict';
  angular.module('vs-agency').controller('agencyDashboardItemCtrl', function($scope, $stateParams, $window, alert) {
    $scope.type = $stateParams.type;
    $scope.dashboardItem = $scope.single('agency:dashboard', $stateParams.id, function(item) {
      if (item) {
